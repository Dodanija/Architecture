...
\subsubsection{AN/UYK-43}
Kompiuterio CPU yra bendros paskirties mikroprogramuojamas valdiklis (MPC), kuris vykdo AN/UYK-43 instrukcijų rinkinio architektūrą (ISA) (HP-9020C/AN/UYK-43 Study, 1987). AN/UYK-43 naudoja tiesioginio kodo kalbą, gautą iš CMS-2Y asemblerio kalbos. Ši sistema leidžia integruoti mašinos instrukcijas į CMS-2Y programas (Fleet combat direction systems support activity code 8, 1986.)
\subsubsection{Intel i960}
